...
import { Loader2, User, Mail, Phone, MapPin, UserSquare, Shield, TrendingUp, KeyRound } from "lucide-react"
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <div className="flex items-center mt-2">
              <Badge
                variant="secondary"
                className={`${user.status === "approved" ? "bg-green-400/20 text-white" : "bg-muted text-muted-foreground"}`}
              > 
          ...
          <Card className="shadow-sm">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Badge 
                  variant="secondary"
                  className={`${user.status === "approved" ? "bg-green-500/10 text-green-600" : "bg-muted text-muted-foreground"}`}
                >
