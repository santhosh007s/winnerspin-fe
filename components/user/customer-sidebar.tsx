...
import { LayoutDashboard, User, CreditCard, Menu, X, ChevronRight } from "lucide-react"
    ...
    <>
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-sidebar-border/30 overflow-hidden w-full flex justify-center">
              <Image src="/Logo-WS.png" alt="logo" width={160} height={100} className=""  />
          </div>
